...
public class SignUpActivity extends MainFragmentActivity implements FragmentContainerActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentManager.beginTransaction().replace(R.id.main_content, SignUpFragment.newInstance()).commit();
